 ...
 */
function atto_linktext_strings_for_js()
{
	global $PAGE;
 ...
 */
function atto_linktext_params_for_js($elementid, $options, $fpoptions)
{
	global $USER, $COURSE;
	//coursecontext
	...
	if (!has_capability('atto/linktext:visible', $coursecontext)) {
		$disabled = true;
	}
